module github.com/NpoolPlatform/dtm-cluster

go 1.17

require (
	github.com/NpoolPlatform/basal-middleware v0.0.0-20230511100621-50f1ac3bac3a
	...
	github.com/NpoolPlatform/message v0.0.0-20230511051843-ab3e057b13cb
